...
class TextGraderServiceTest extends TestCase
{
    /**
    ...
    {
        $this->assertEquals(2, $this->grader->score('I want to address our recent acquisition')->getScore());
    }
    ...
    public function testTextWithNoBusinessWordsGradesZero()
    {
        ...
        $this->assertEquals(0, $this->grader->score($text)->getScore());
    }
}
